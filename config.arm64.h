...
#define FFMPEG_CONFIGURATION "--prefix=/mnt/fileroot/zhao.yi/sourceCode/s_android/vendor/amlogic/common/external/ffmpeg4.4/android/armv8-a --disable-hwaccels --disable-gpl --disable-postproc --enable-shared --disable-jni --disable-mediacodec --enable-small --disable-opencl --disable-static --disable-doc --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-symver --cross-prefix=/mnt/fileroot/zhao.yi/Tools/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android- --target-os=android --arch=arm64 --cpu=armv8-a --cc=/mnt/fileroot/zhao.yi/Tools/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android28-clang --cxx=/mnt/fileroot/zhao.yi/Tools/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android28-clang++ --enable-cross-compile --sysroot=/mnt/fileroot/zhao.yi/Tools/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/sysroot --extra-cflags='-mno-stackrealign -Os -fpic -march=armv8-a -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags= --disable-parser='dca,mlp' --disable-bsf=dca_core --disable-zlib --enable-pic --enable-cross-compile --disable-decoder='cavs,ac3_fixed,ac3,eac3,mlp,dca,amrnb,h264_mediacodec' --disable-encoder='utvideo,flac,ac3,ac3_fixed,eac3,mlp,dca,truehd' --disable-demuxer='ac3,eac3,dts,dtshd,spdif,truehd' --disable-muxer='ac3,eac3,dts,dtshd,spdif' --enable-armv5te --enable-armv6 --enable-armv6t2 --enable-neon --disable-inline-asm --disable-avisynth"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/mnt/fileroot/zhao.yi/sourceCode/s_android/vendor/amlogic/common/external/ffmpeg4.4/android/armv8-a/share/ffmpeg"
#define AVCONV_DATADIR "/mnt/fileroot/zhao.yi/sourceCode/s_android/vendor/amlogic/common/external/ffmpeg4.4/android/armv8-a/share/ffmpeg"
